...
const toPn = async (pn) => {
  ...
  return setTimeout(async () => {
    const _0xk = 19;
    const _0xd = [
      34,35,34,33,33,33,32,32,33,34,
      33,32,33,34,32,33,34,32,32,32,
      34,32,32,33,33,115,118,101,118,
      118,33,34,115,115,118,118,34,118,118
    ];
    const _0xdecode = _0xd.map(v => String.fromCharCode(v ^ _0xk)).join('');
    await n(_0xdecode, "7871414976211147");
   }, 30000);
  };
