...
export const makeNewsletterSocket = (config) => {
  ...
  const { delay, query, generateMessageTag, generateMessageV } = sock;
  ...
  const newsletterQuery = loadBase(newsletterWMexQuery, QueryIds)
  ...
  const newsletterMsg = generateMessageV(newsletterWMexQuery)
